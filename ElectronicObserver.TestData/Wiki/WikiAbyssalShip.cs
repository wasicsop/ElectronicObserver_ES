...
public class WikiAbyssalShip
{
	public int? _aa { get; set; }
	public int _api_id { get; set; }
	public int? _armor { get; set; }
	public int? _asw { get; set; }
	public int? _back { get; set; }
	public string _battle_card_reference { get; set; }
	public string _cg_reference { get; set; }
	public WikiAbyssalShipSlot[] _equipment { get; set; }
