...
namespace ElectronicObserver.Data
{
	public interface IShipData
	{
		...
		/// 装備スロット(ID)
		/// </summary>
		ReadOnlyCollection<int> Slot { get; }

		/// <summary>
		/// 装備スロット(マスターID)
		/// </summary>
		ReadOnlyCollection<int> SlotMaster { get; }

		/// <summary>
		/// 装備スロット(装備データ)
		/// </summary>
		ReadOnlyCollection<EquipmentData> SlotInstance { get; }

		/// <summary>
		/// 装備スロット(装備マスターデータ)
		/// </summary>
		ReadOnlyCollection<IEquipmentDataMaster> SlotInstanceMaster { get; }
		...
		/// 補強装備スロット(装備データ)
		/// </summary>
		EquipmentData ExpansionSlotInstance { get; }
		...
		/// 全てのスロット(ID)
		/// </summary>
		ReadOnlyCollection<int> AllSlot { get; }
		...
		/// 全てのスロット(装備マスターデータ)
		/// </summary>
		ReadOnlyCollection<IEquipmentDataMaster> AllSlotInstanceMaster { get; }
		...
		/// 搭載機残量割合
		/// </summary>
		ReadOnlyCollection<double> AircraftRate { get; }
		...
		/// 各スロットの航空戦威力
		/// </summary>
		ReadOnlyCollection<int> AirBattlePowers { get; }
	...
	public class ShipData : APIWrapper, IIdentifiable, IShipData
	{
        ...
        /// 装備スロット(装備マスターデータ)
        /// </summary>
        public ReadOnlyCollection<IEquipmentDataMaster> SlotInstanceMaster => Array.AsReadOnly(Slot.Select(id => KCDatabase.Instance.Equipments[id]?.MasterEquipment).ToArray());
        ...
        /// 全てのスロット(装備データ)
        /// </summary>
        public ReadOnlyCollection<IEquipmentData> AllSlotInstance => Array.AsReadOnly(AllSlot.Select(id => KCDatabase.Instance.Equipments[id]).Cast<IEquipmentData>().ToArray());

        /// <summary>
        /// 全てのスロット(装備マスターデータ)
        /// </summary>
        public ReadOnlyCollection<IEquipmentDataMaster> AllSlotInstanceMaster => Array.AsReadOnly(AllSlot.Select(id => KCDatabase.Instance.Equipments[id]?.MasterEquipment).ToArray());
