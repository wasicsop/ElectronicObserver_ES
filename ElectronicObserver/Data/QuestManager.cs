...
namespace ElectronicObserver.Data
{
	...
	public class QuestManager : APIWrapper
	{
		...
		public override void LoadFromResponse(string apiname, dynamic data)
		{
			...
			{
				progress.Progresses.RemoveAll(p => (p.QuestType == 1 || p.QuestID == 211 /* 空母3 */ || p.QuestID == 212 /* 輸送5 */ || p.QuestID == 311 /* 演習勝利7 */ || p.QuestID == 330 || p.QuestID == 337 || p.QuestID == 339 || p.QuestID == 341 || p.QuestID == 342));
