...
namespace ElectronicObserver.Window.Dialog
{
    partial class DialogExpeditionCheck
    {
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(DialogExpeditionCheck));
			...
			resources.ApplyResources(this.CheckView_Name, "CheckView_Name");
			...
			resources.ApplyResources(this.CheckView_Fleet2, "CheckView_Fleet2");
			...
			resources.ApplyResources(this.CheckView_Fleet3, "CheckView_Fleet3");
			...
			resources.ApplyResources(this.CheckView_Fleet4, "CheckView_Fleet4");
			...
			resources.ApplyResources(this.CheckView_Condition, "CheckView_Condition");
