namespace ElectronicObserver.Window.Dialog {
	partial class DialogAlbumShipParameter {
		...
		private void InitializeComponent() {
			...
			this.ParameterView_Key.HeaderText = EncycloRes.ParameterView_Key;
			...
			this.ParameterView_Value.HeaderText = EncycloRes.ParameterView_Value;
			...
			this.label1.Text = EncycloRes.EditShipParameterHint;
			// 
			...
			this.Text = EncycloRes.EditShipParameter;
