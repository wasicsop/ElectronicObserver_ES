namespace ElectronicObserver.Window.Dialog {
	partial class DialogResourceChart {
		...
		private void InitializeComponent() {
			...
			this.Menu_Span_Day.Text = GeneralRes.Day;
			...
			this.Menu_Span_Week.Text = GeneralRes.Week;
			...
			this.Menu_Span_Month.Text = GeneralRes.Month;
			...
			this.Menu_Span_Season.Text = GeneralRes.ThreeMonths;
			...
			this.Menu_Span_Year.Text = GeneralRes.Year;
			...
			this.Menu_Span_All.Text = GeneralRes.AllData;
			...
			this.ResourceChart.Text = GeneralRes.ResourceChart;
			...
			this.Text = GeneralRes.ResourceChart;
