	...
	public class start : APIBase
	{
		...
		public override void OnRequestReceived(Dictionary<string, string> data)
		{
			...
			*/
			...
			Utility.Logger.Add(2, string.Format("#{0} 「{1}」 has been sent to expedition 「{2}: {3}」.", deckID, KCDatabase.Instance.Fleet[deckID].Name, destination, KCDatabase.Instance.Mission[destination].Name));
